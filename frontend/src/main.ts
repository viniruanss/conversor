...
function pegarExtensao(nomeArquivo: string): string {
...
const botaoConverter = document.querySelector<HTMLButtonElement>("#btnConverter");
...
const formatoSaida = document.querySelector<HTMLSelectElement>("#formatoSaida");
